              ...
              <Tile title="Mail" color={'#00ADEF'} className="tile--small tile--contact tile--mail" flipped={flipped} style={{ height: '100%' }}>
                <div className="tile-center-logo" aria-hidden>
                  <svg viewBox="0 0 48 48" width="50%" height="50%" aria-hidden focusable="false" style={{ display: 'block' }}>
                    <path d="M6.47,10.71a2,2,0,0,0-2,2h0V35.32a2,2,0,0,0,2,2H41.53a2,2,0,0,0,2-2h0V12.68a2,2,0,0,0-2-2H6.47Zm33.21,3.82L24,26.07,8.32,14.53" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </Tile>
            </a>
